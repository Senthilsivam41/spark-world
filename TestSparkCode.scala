...
object TestSparkCode {
  ...
  def main(args: Array[String]): Unit ={
    ...
    val logFile = "file:////Users/sesadasivam/Documents/Sendil/input/InputDataFile.txt" // Should be some file on your system
    val jobName = "TestSparkCode"
    val conf = new SparkConf().setAppName(jobName).setMaster("local[*]")
    val sc = new SparkContext(conf)
    val pathToFiles = logFile //args(0)
    val outputPath = "file:///Users/sesadasivam/Documents/Sendil/input/result" //args(1)
